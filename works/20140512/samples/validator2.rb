...
SampleController.register_user id: 'hagiwara', name: 'hagiwaratakashi'
SampleController.register_user id: 'hagiwara', name: 'hagiwaratakashi', email: 'hagi@'
SampleController.register_user email: 'hoge'
